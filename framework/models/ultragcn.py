...
class UltraGCN(nn.Module):
    def __init__(self, args, constraint_mat, ii_constraint_mat, ii_neighbor_mat, embedding_dim=64, **kwargs,):
        super(UltraGCN, self).__init__()
        self.user_num = args.num_users
        self.item_num = args.num_items
        self.embedding_dim = args.out_dim
        self.w1 = args.w1
        self.w2 = args.w2
        self.w3 = args.w3
        self.w4 = args.w4
    ...
    def get_omegas(self, users, pos_items, neg_items):
        ...
        if self.w4 > 0:
            neg_weight = torch.mul(torch.repeat_interleave(self.constraint_mat['beta_uD'][users], neg_items.size(1)), self.constraint_mat['beta_iD'][neg_items.flatten().long()]).to(device)
    ...
    def cal_loss_L(self, users, pos_items, neg_items, omega_weight):
        ...
        # print(user_embeds.size(), neg_embeds.size())
